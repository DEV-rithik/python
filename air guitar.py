...
BAUD_RATE = 115200
SAMPLE_RATE = 44100
MIN_STRUM_FORCE = 60  # Made more sensitive! 
...
def main():
    ...
    # TEST AUDIO - Play a note to verify sound works
    print("🎵 Testing audio...  you should hear a note!")
    test_sound = generate_string_sound(196.00, duration=1.0)  # G note - FIXED! 
    engine.add_sound(test_sound)
    time.sleep(2)
    print("Did you hear it? If yes, audio is working!\n")
            ...
            if ser.in_waiting:
                try:
                    ...
                    if ":" in line: 
                        ...
                        # DEBUG OUTPUT
                        print(f"Roll: {current_roll: 6.1f}°  Force: {force:4d}", end="")
